...
public class Trajectories {
    ...
    public static AutoFunction[] getSlalom(double pwr) {
        AutoFunction traj[] = {
            new PointNTurn(0, pwr, 1.5), 
            new PointNTurn(-49, pwr, 5.0),
            new PointNTurn(0, pwr, 8.45),
            new PointNTurn(55, pwr, 5.67),
            new PointNTurn(-45, pwr, 4.14), 
            new PointNTurn(-135, pwr, 3.54),
            new PointNTurn(130, pwr, 6.0), 
            new PointNTurn(180, pwr, 8.35), 
