...
//     public  static boolean reqInjShtr = false;
...
//         if (reqInjShtr && once) {
//             state = 1;
//             once = false; // set true once unload/shot is finished
//         }
...
//     // Returns true 0.25 sec. after starting motors and false 0.25 sec. before shutdown
...
//         SmartDashboard.putNumber("Injector State", state);
